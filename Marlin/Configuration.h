...
#define STRING_CONFIG_H_AUTHOR "Paul Grove" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "SKR13 V6 ZESTY"         // will be shown during bootup in line 2
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 1280, 1280, 1600, 2700 }
 ...
 *   (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER -43.5  // X offset: -left  +right  [of the nozzle]
